            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="space-y-8 md:space-y-10">
                        ...
                        <p className="text-xl sm:text-2xl font-semibold leading-relaxed text-accent-yellow">
                        ...
                        <p className="text-2xl sm:text-3xl font-light leading-snug pt-4">
                    ...
                    <div className="flex flex-col items-center md:items-end space-y-8 mt-10 md:mt-0">
                        ...
                        <div className="w-full max-w-xs sm:max-w-sm h-auto overflow-hidden"> 
                            <img 
                                src={rocketKidImage} 
                                alt="Criança com mochila de foguete, simbolizando inovação e resultados." 
                                className="w-full h-auto object-cover transition duration-500 hover:scale-[1.05]"
                            />
                        </div>
                        ...
                        <div className="text-center md:text-right pt-4">
                            ...
                            <div className="flex space-x-6 justify-center md:justify-end">
                                ...
                                <a 
                                    href={`https://wa.me/${whatsappNumber}`} // AQUI ESTÁ A MUDANÇA
                                    target="_blank" 
